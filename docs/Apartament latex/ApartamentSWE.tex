...
\textbf{1 Introduzione \hfill 2}\\
\hspace{\parindent} \hspace{\parindent} 1.1 Descrizione del Progetto \dotfill 2 \\ \hspace{\parindent} \hspace{\parindent} 1.2 Struttura del Progetto \dotfill 2 
...
\begin{center}
\includegraphics[scale=0.4]{usecases/UseCase1}
