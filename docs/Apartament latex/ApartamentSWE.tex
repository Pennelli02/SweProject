...
Flusso Base & 
\begin{enumerate}
    \item L'utente inserisce le sue credenziali (email e password) (\hyperref[mk1]{MK\#1} e \hyperref[mk3]{MK\#3})(\hyperref[test1]{Tst\#1}).
...
\par\medskip
\begin{center}
\includegraphics[scale=0.55]{Snippets/Singleton}
\par\medskip
...
\par\medskip
\begin{center}
\includegraphics[scale=0.55]{test/BusinessLogic/risultatitest}
\par\medskip
